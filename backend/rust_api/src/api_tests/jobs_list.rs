...
async fn jobs_list_route_prefers_live_pipeline_stage_snapshot() {
    ...
    fs::write(
        ...
        concat!(
r#"{"job_id":"job-route-list-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 3/8 translation","provider":"","provider_stage":"","event_type":"stage_progress","message":"Completed batch 3/8 translation","progress_current":3,"progress_total":8,"retry_count":0,"elapsed_ms":900,"payload":{}}"#,
            "\n",
