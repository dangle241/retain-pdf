...
async fn job_detail_route_prefers_live_pipeline_stage_snapshot() {
    ...
    fs::write(
        ...
        concat!(
r#"{"job_id":"job-route-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 2/5 translation","provider":"","provider_stage":"","event_type":"stage_progress","message":"Completed batch 2/5 translation","progress_current":2,"progress_total":5,"retry_count":0,"elapsed_ms":1000,"payload":{}}"#,
            "\n",
