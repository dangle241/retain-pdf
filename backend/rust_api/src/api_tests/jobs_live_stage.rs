...
async fn job_detail_list_and_events_share_pipeline_event_priority() {
    ...
    fs::write(
        ...
        concat!(
r#"{"job_id":"job-route-shared-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 4/9 translation","provider":"","provider_stage":"","event":"stage_progress","message":"Completed batch 4/9 translation","progress_current":4,"progress_total":9,"retry_count":0,"elapsed_ms":900,"payload":{"origin":"python"}}"#,
            "\n",
r#"{"job_id":"job-route-shared-live-stage","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"saving","stage_detail":"Final PDF published","provider":"","provider_stage":"","event":"artifact_published","message":"Final PDF published","progress_current":null,"progress_total":null,"retry_count":0,"elapsed_ms":1000,"payload":{"artifact_key":"output_pdf"}}"#,
    ...
    assert_eq!(detail_stage["stage_detail"], "Completed 4/9 Batch Translate");
...
async fn job_detail_keeps_render_prewarm_as_background_stage() {
    ...
    fs::write(
        job_root.join("logs").join("pipeline_events.jsonl"),
        concat!(
r#"{"job_id":"job-route-render-prewarm-background","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Translating batch 8/42","event":"stage_progress","message":"Translating batch 8/42","progress_current":8,"progress_total":42,"progress_unit":"batch","payload":{"origin":"python"}}"#,
            "\n",
            r#"{"job_id":"job-route-render-prewarm-background","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"rendering","substage":"render_prewarm","stage_detail":"Render warmup complete","event":"stage_progress","message":"render payload prewarm: ready indents=333 geometry=836 elapsed=1.58s","progress_current":2,"progress_total":3,"progress_unit":"step","payload":{"origin":"python"}}"#,
            "\n"
        ),
    )
    .expect("write pipeline events");
...
async fn running_job_detail_does_not_select_premature_done_event_over_active_stage() {
    ...
    fs::write(
        job_root.join("logs").join("pipeline_events.jsonl"),
        concat!(
r#"{"job_id":"job-route-running-ignore-premature-done","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"ocr_processing","stage_detail":"OCR page 10/10","event":"stage_progress","message":"OCR page 10/10","progress_current":10,"progress_total":10,"progress_unit":"page","payload":{}}"#,
            "\n",
            r#"{"job_id":"job-route-running-ignore-premature-done","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"finished","stage_detail":"Task complete","event":"job_terminal","event_type":"job_terminal","message":"Task reached terminal state. succeeded","payload":{"status":"succeeded"}}"#,
            "\n",
r#"{"job_id":"job-route-running-ignore-premature-done","seq":3,"ts":"2026-04-24T01:00:02Z","level":"info","stage":"translating","stage_detail":"Translating batch 2/8","event":"stage_progress","message":"Translating batch 2/8","progress_current":2,"progress_total":8,"progress_unit":"batch","payload":{}}"#,
            "\n"
        ),
    )
    .expect("write pipeline events");
...
async fn running_job_detail_prefers_latest_retry_stage_over_old_higher_rank_stage() {
    ...
    fs::write(
        job_root.join("logs").join("pipeline_events.jsonl"),
        concat!(
r#"{"job_id":"job-route-running-retry-latest-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"rendering","stage_detail":"Old run rendering page 8/10","event":"stage_progress","message":"Old run rendering page 8/10","progress_current":8,"progress_total":10,"progress_unit":"page","payload":{"attempt":1}}"#,
            "\n",
r#"{"job_id":"job-route-running-retry-latest-stage","seq":2,"ts":"2026-04-24T01:01:00Z","level":"info","stage":"translating","stage_detail":"Retry translating batch 1/5","event":"stage_progress","message":"Retry translating batch 1/5","progress_current":1,"progress_total":5,"progress_unit":"batch","payload":{"attempt":2}}"#,
            "\n"
        ),
    )
    .expect("write pipeline events");
...
async fn terminal_job_detail_uses_status_not_done_display_stage() {
    ...
    fs::write(
        job_root.join("logs").join("pipeline_events.jsonl"),
r#"{"job_id":"job-route-terminal-null-stage-snapshot","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"finished","stage_detail":"Task complete","event":"job_terminal","event_type":"job_terminal","message":"Task entered terminal state succeeded","payload":{"status":"succeeded"}}"#,
    )
    .expect("write pipeline events");
