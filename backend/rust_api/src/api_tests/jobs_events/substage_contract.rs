...
async fn job_events_route_classifies_new_pipeline_substages() {
    ...
    fs::write(
        ...
        concat!(
r#"{"job_id":"job-route-new-pipeline-substages","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"agent_repair","substage":"agent_repair","stage_detail":"Translation result repair complete","event_type":"stage_progress","semantic_event_type":"progress","message":"Translation result repair complete","progress_current":1,"progress_total":2,"payload":{}}"#,
            "\n",
            r#"{"job_id":"job-route-new-pipeline-substages","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"render_preprocess","substage":"render_prewarm","stage_detail":"Render payload Ready.","event_type":"stage_progress","semantic_event_type":"progress","message":"render payload prewarm: ready","progress_current":2,"progress_total":3,"progress_unit":"step","payload":{}}"#,
            "\n"
        ),
    )
