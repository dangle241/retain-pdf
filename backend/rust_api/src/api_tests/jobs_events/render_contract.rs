...
async fn job_events_route_keeps_rendering_page_progress_events() {
    ...
    fs::write(
        ...
        concat!(
r#"{"job_id":"job-route-render-progress","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"rendering","stage_detail":"Rendering page 1/3","provider":"","provider_stage":"","event_type":"stage_progress","message":"Rendering page 1/3","progress_current":1,"progress_total":3,"retry_count":0,"elapsed_ms":1000,"payload":{"page_index":0,"render_stage":"book_overlay"}}"#,
            "\n",
            r#"{"job_id":"job-route-render-progress","seq":2,"ts":"2026-04-24T01:00:01Z","level":"error","stage":"failed","stage_detail":"Render failed","provider":"","provider_stage":"","event_type":"job_terminal","message":"Task enters final state failed","progress_current":null,"progress_total":null,"retry_count":0,"elapsed_ms":1100,"payload":{}}"#,
            "\n"
        ),
    )
...
async fn job_events_route_canonicalizes_render_prewarm_even_when_user_stage_is_stale() {
    ...
    fs::write(
        job_root.join("logs").join("pipeline_events.jsonl"),
r#"{"job_id":"job-route-render-prewarm-canonical","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","user_stage":"translation","stage":"rendering","substage":"render_prewarm","stage_detail":"Render prewarm complete","event_type":"stage_progress","message":"render payload prewarm: ready indents=333 geometry=836 elapsed=1.58s","progress_current":2,"progress_total":3,"progress_unit":"step","payload":{"render_stage":"payload_prewarm"}}"#,
    )
    .expect("write pipeline events");
