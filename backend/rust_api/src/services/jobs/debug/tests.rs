        ...
        serde_json::to_vec_pretty(&json!([
            {
                ...
                "translated_text": "đoạn tiếng Trung, có công thức $E=mc^2$",
...
fn debug_item_view_reads_item_from_manifest_payload() {
        ...
        serde_json::to_vec_pretty(&json!([
            {
                ...
                "translated_text": "đoạn văn bản tiếng Trung",
                "api_key": "sk-secret",
                "translation_diagnostics": {
    ...
    assert_eq!(view.item["translated_text"], "đoạn văn bản tiếng Trung");
