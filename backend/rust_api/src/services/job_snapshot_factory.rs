...
impl JobInit {
    pub fn ocr_default() -> Self {
        Self {
            ...
            stage: Some("queued"),
            stage_detail: Some("Đã tạo tác vụ OCR, đang chờ lượt xử lý"),
        }
    }
    ...
    pub fn translate_default() -> Self {
        Self {
            ...
            schema_version: None,
            stage: Some("queued"),
            stage_detail: Some("Đã tạo tác vụ dịch, đang chờ tác vụ OCR con"),
        }
    }
    ...
    pub fn book_default() -> Self {
        Self {
            ...
            stage: Some("queued"),
            stage_detail: Some(
                "Đã tạo tác vụ toàn quy trình, đang chờ xử lý OCR, dịch và kết xuất",
            ),
        }
    }
    ...
    pub fn render_default() -> Self {
        Self {
            ...
            schema_version: None,
            stage: Some("queued"),
            stage_detail: Some("Đã tạo tác vụ kết xuất, đang chờ lượt xử lý"),
        }
    }
}
