...
pub(super) fn mark_parent_ocr_submitting(
    ...
    parent_job.stage_detail = Some("Đang khởi động tác vụ con OCR".to_string());
...
pub(super) fn create_ocr_child_job(
    ...
    ocr_child.stage_detail = Some("Tác vụ con OCR đã được tạo".to_string());
