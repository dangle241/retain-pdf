...
def run_initial_continuation_pass(
    *,
    ...
    emit_stage_progress(
        ...
        message="Initial continuation segment arrangement completed",
...
def run_continuation_review(
    *,
    ...
    emit_stage_transition(
        stage="continuation_review",
        substage="continuation_review",
        message="Start reviewing cross-column/cross-page continuations",
        progress_current=0,
    ...
    review_and_apply_continuations(
        ...
        progress_callback=lambda current, total: emit_stage_progress(
            stage="continuation_review",
            substage="continuation_review",
            message=f"Reviewing cross-column/cross-page continuations, batch {current}/{total}",
    ...
    emit_stage_progress(
        stage="continuation_review",
        substage="continuation_review",
        message="Cross-column/cross-page continuation review completed",
