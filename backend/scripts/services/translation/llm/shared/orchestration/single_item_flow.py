...
# Item-by-item terminology matching guide. item injects into user message (see prompt_protocols),
# No entry system message — otherwise each request prefix differs, prefix cache invalidated.
