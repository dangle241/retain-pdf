...
def run_book_pipeline(
    *,
    ...
    return {
        ...
        "source_language": translation_summary.get("source_language", source_language),
        "target_language": translation_summary.get("target_language", target_language),
        "target_language_name": translation_summary.get("target_language_name", target_language_name),
