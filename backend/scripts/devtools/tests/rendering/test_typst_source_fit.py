    ...
    spec = RenderPageSpec(
        ...
        blocks=[
            RenderLayoutBlock(
                ...
                content_kind="markdown",
content_text=r"Body text $\\frac{\\partial E}{\\partial R}$ Continue explanation.",
                plain_text="Continue in main text.",
                math_map=[],
                font_size_pt=10.0,
                leading_em=0.6,
                fit_to_box=True,
    ...
    spec = RenderPageSpec(
        ...
        blocks=[
            RenderLayoutBlock(
                ...
                content_text="",
                plain_text="This is a passage from Typst Long plain text from compatibility downgrade. Keep block-width line breaks. Do not scale to single-line width – nearly unreadable.",
                math_map=[],
                font_size_pt=10.0,
                leading_em=0.56,
