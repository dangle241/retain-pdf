...
// Kết xuất vùng mục đã lưu trên đám mây tách riêng với trích đoạn ảnh chụp cục bộ.
// Mọi văn bản máy chủ dùng textContent, cấm innerHTML để ngăn injection nội dung trích dẫn.
export function renderServerFavorites(sectionEl, records = [], {
  ...
  head.textContent = "Mục đã lưu trên đám mây";
  ...
  records.forEach((record) => {
    ...
    removeButton.setAttribute("aria-label", "Xóa mục đã lưu trên đám mây");
