      ...
      items: [
        {
          ...
          name: "Thuật ngữ hóa học lượng tử mô phỏng",
          entry_count: 2,
          created_at: "",
          updated_at: "",
        },
...
export async function fetchGlossary(glossaryId, apiPrefix) {
  ...
  if (isMockMode()) {
    ...
    return {
      ...
      name: normalizedGlossaryId === "mock-glossary-quantum" ? "Thuật ngữ hóa học lượng tử mô phỏng" : "Bảng thuật ngữ mô phỏng",
      entry_count: 2,
      entries: [
        {
          source: "Hartree-Fock",
