...
export function createRecentJobsNavigationPort({
  ...
  /** Lưới thư viện mặc định false: tiến độ nằm trong tab chi tiết sách, không bật cửa sổ workflow cũ. */
  ...
  return {
    ...
    recoverJob(jobId) {
      ...
      // Ưu tiên recoverJob (poll silent); tương thích cổng cũ chỉ có openJob.
