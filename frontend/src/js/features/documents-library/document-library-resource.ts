// Documentation center grid data source resource wrap (plan F2), mirror.
// recent-jobs/library-books-resource.js shape, for recent-jobs engine's
// loader.js/bindings.js treat as libraryBooksResource Use injection.
