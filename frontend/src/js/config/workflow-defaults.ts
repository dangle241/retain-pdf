...
// Mặc định dịch theo lô khớp với engine Python (TranslationExecutionRequest.batch_size=8):
// batch=1 tách mỗi khối thành yêu cầu riêng, làm hàng đợi batch và ngữ cảnh trong batch mất tác dụng hoàn toàn.
