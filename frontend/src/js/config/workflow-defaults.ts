...
// Align with Python engine default batch translation policy (TranslationExecutionRequest.batch_size=8):
// batch=1 Splits each block into independent requests.,Batch queue and intra-batch context completely invalid.
