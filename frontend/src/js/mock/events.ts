  ...
  const items: any[] = [
    {
      ...
      level: "info",
      stage: "queued",
      stage_detail: "PDF Upload complete. Task queued.",
      event_type: "stage_progress",
      event: "stage_progress",
message: "PDF upload complete, task entered queue",
      progress_current: 2,
      progress_total: 12,
      payload: { scenario },
    },
...
stage_detail: "Performing OCR, page 5/12",
      provider: "paddle",
      provider_stage: "paddle_running",
      event_type: "stage_progress",
      event: "stage_progress",
message: "Performing OCR, page 5/12",
...
stage_detail: "Translating text and formulas, batch 18/55",
      event_type: "progress",
      event: "stage_progress",
message: "Translating body text and formulas, batch 18/55",
  ...
  if (scenario === "parallel") {
    items.push({
      ...
      stage_detail: "Backend preheat render resources",
      event_type: "progress",
      event: "stage_progress",
  ...
  if (["render", "done", "failed"].includes(scenario)) {
    items.push({
      ...
      level: "info",
      stage: "rendering",
stage_detail: scenario === "failed" ? "Rendering page 9/12" : "Rendering page 8/12",
      event_type: "stage_progress",
      event: "stage_progress",
message: scenario === "failed" ? "Rendering page 9/12" : "Rendering page 8/12",
  ...
  if (scenario === "done") {
    items.push({
      ...
      level: "info",
      stage: "finished",
      stage_detail: "PDF Generated, ready to download.",
      event_type: "artifact_published",
      event: "artifact_published",
message: "PDF generated, available for download",
      progress_current: 12,
      progress_total: 12,
  ...
  if (scenario === "failed") {
    items.push({
      ...
      level: "error",
      stage: "rendering",
stage_detail: "Rendering stage failed",
      event_type: "job_failed",
      event: "job_failed",
message: "Rendering stage failed",
      progress_current: 9,
      progress_total: 12,
