// UI hỏi đáp AI: thanh hội thoại + luồng tin nhắn + vùng nhập.
// Nội dung bong bóng vẫn là vùng mệnh lệnh độc lập (handle answer-view); giữ nguyên ID cấu trúc và hợp đồng kiểm thử.
      ...
      {showSessionChrome ? (
        <div className="reader-ai-sessions" data-reader-ai-sessions="">
          <select
            ...
            aria-label="Chuyển cuộc trò chuyện trong lịch sử"
        ...
        // ID hợp đồng vẫn gắn trong DOM để kiểm thử/automation định vị (thu gọn về mặt hình ảnh).
        <div className="reader-ai-sessions is-collapsed" data-reader-ai-sessions="" hidden>
          ...
          <button id="reader-ai-new-btn" type="button" className="reader-ai-session-btn" onClick={() => void chat.newConversation()}>Cuộc trò chuyện mới</button>
      ...
      <div id="reader-ai-thread" className="reader-ai-thread" aria-live="polite" ref={chat.threadRef}>
        {chat.messages.length === 0 ? (
          <div className="reader-float-ai-thread-hint" data-reader-ai-empty-hint="">
            <p>Đặt câu hỏi cho toàn bộ tài liệu hiện tại</p>
            <span>Câu trả lời sẽ cố gắng trích dẫn các đoạn trong tài liệu; có thể bấm để chuyển đến đó</span>
