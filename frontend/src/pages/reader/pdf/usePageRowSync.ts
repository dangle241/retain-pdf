// Chuyển nghiêm ngặt pdf-layout.syncReaderPageRows cũ nhưng ghi lại bằng trạng thái React,
// tránh việc sửa minHeight trong DOM bị style React ghi đè.
...
function measureNaturalPageHeight(slot: HTMLElement): number {
  // Ưu tiên đo nội dung "mặt giấy", không lấy minHeight đã được nâng.
 ...
 * Chỉ có mục khi cả trái và phải đều có trang đó (giống việc skip khi length < 2 trong bản cũ).
 *
