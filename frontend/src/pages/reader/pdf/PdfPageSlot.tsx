// Trang đơn: căn với createManualPageElement + setManualPageSize cũ (chiều rộng/cao cố định).
// Khi đối chiếu, syncedMinHeight đến từ chiều cao max của syncReaderPageRows.
...
export type PdfPageSlotProps = {
  ...
  pane?: ReaderPaneId;
  /** Chiều cao max của cùng trang bên trái/phải khi đối chiếu. */
...
function PdfPageSlotInner({
  ...
  // Engine cũ cố định height của trang = viewport × scale.
