// Single pages: align with old createManualPageElement + setManualPageSize (fixed width/height)
// When side-by-side, syncedMinHeight comes from the max height of syncReaderPageRows
...
export type PdfPageSlotProps = {
  ...
  pane?: ReaderPaneId;
  /** Left/right pages share the same max height in side-by-side mode */
...
function PdfPageSlotInner({
  ...
  // Old engine: fixed page height = viewport * scale
