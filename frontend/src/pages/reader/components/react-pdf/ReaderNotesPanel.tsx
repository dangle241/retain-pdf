// Cửa sổ nổi chú thích: danh sách / ghi chú / xóa / xuất / định vị.
    ...
    <article className="reader-notes-item">
      <div className="reader-notes-item-top">
        <span className="reader-notes-kind">
          {note.pane === "translated" ? "Bản dịch" : "Nguyên văn"}
        </span>
...
export function ReaderNotesPanel({
  ...
  return (
    <ReaderFloatShell
      ...
      open={open}
      title="Chú thích"
      subtitle="Chọn văn bản PDF để thêm · Lưu cục bộ"
    ...
    >
      {count === 0 ? (
        <p className="reader-notes-empty">
          Chưa có chú thích. Kéo chọn văn bản trên PDF rồi bấm “Thêm chú thích”.
        </p>
      ) : (
        groups.map((group) => (
