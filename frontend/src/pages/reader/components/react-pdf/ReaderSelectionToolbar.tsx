// Thanh nổi khi chọn văn bản: thêm chú thích (chỉ trình đọc mới).
...
export function ReaderSelectionToolbar({
  ...
  // Ưu tiên phía trên vùng chọn; nếu không đủ chỗ thì chuyển xuống dưới.
  ...
  const paneLabel = selection.pane === "translated" ? "Bản dịch" : "Nguyên văn";
