...
export function createCredentials({
  ...
  // balance/legacy ports have default implementations inside mount; the lower-layer signature is still marked as required.
  const browserCredentialsFeature = mountBrowserCredentialsFeature({
    ...
    onCredentialStateChange: () => {
      ...
      // Notify AI input gate etc.: only trust modelApiKey from Settings
      try {
