// Assemble HomeServices external bag (HomeApp / useHomeServices consumption).
  ...
  return {
    ...
    library: {
      ...
      actions: {
        ...
        // Grid task selection → Detail translation TabAlert never show. Remove alert code. #translation-workflow-dialog）
