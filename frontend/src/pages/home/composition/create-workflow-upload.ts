...
export function createWorkflowAndUpload({
  ...
  function readSubmitValues({
    ...
    // providerId chỉ được truyền cho lệnh gọi cũ; getOcrToken chỉ đọc defaultPaddleToken.
  ...
  // Chữ ký mountUploadFeature yêu cầu state nhưng uploadStatePort đã đủ ở runtime; chữ ký nocheck lớp dưới chưa được nới.
