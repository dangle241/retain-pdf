...
// Collapse into one hook,Component subscribes only to required slices,No individual repetition. useStoreSnapshot/
//
...
/** controller Surface (JSX Directly invoked method) */
