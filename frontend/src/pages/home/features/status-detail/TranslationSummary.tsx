// Gỡ lỗi bản dịch: thẻ đếm + gợi ý bộ lọc hiện tại; bản viết lại JSX của
// thao tác ghi DOM trong status-detail-dialog-translation.js#renderTranslationSummary
// (finalStatusCounts được ưu tiên hơn counts, giống hệ thống cũ); summarizeTranslationFilter
// là hàm định dạng thuần nên được giữ lại và import trực tiếp.
  ...
  return (
    <section className="translation-summary-shell">
      <div className="translation-summary-grid">
        ...
        <div className="translation-summary-card"><span className="label">Giữ nguyên văn</span><span id={ids.countKeptOrigin} className="info-value">{counts.kept_origin ?? 0}</span></div>
