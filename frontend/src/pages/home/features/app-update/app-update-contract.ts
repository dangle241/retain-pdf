// AppUpdateBanner 的 id/Status契约(蓝图 §5 + §0.1).
//
// 拷贝自 src/js/components/layout/app-update-dom-contract.js(旧自定义元素
// View层,architecture-boundaries 门禁禁止 src/pages/** 直接 import
// js/components/**)——同一手法 3a Stage已在
// src/pages/home/features/app-shell/app-update-contract.js 用过一次(当时只
// required IDS,详情 dialog 骨架临时挂在 AppShellHeader.jsx).booksFiles补齐
// STATES/CLASSES,yes 3b app-update 域(按钮 + 详情 dialog 合并进
