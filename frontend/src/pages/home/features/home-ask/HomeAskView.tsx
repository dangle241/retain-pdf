      ...
      <div className="home-ask-main">
        {empty ? (
          <div className="home-ask-hero">
            ...
            <h2 className="home-ask-empty-title">Ready when you are. What can I help with?</h2>
            <HomeAskComposer
              isRunning={isRunning}
              ...
              variant="hero"
            />
            <div className="home-ask-suggestions" role="group" aria-label="Suggested questions">
