// Hàng trong view danh sách giá sách, dựa trên BookListRow của PDF_MD_lib: bìa nhỏ + tiêu đề/phụ đề/
// ngày cập nhật + biểu tượng mắt bên phải (đọc nhanh). Bấm hàng → hộp thoại chi tiết. Dữ liệu/hành động giống thẻ.
...
function formatDate(value: string | null | undefined) {
  ...
  return new Intl.DateTimeFormat("vi-VN", { year: "numeric", month: "numeric", day: "numeric" }).format(parsed);
}
...
function BookListRowImpl({
  ...
  function open() {
    ...
    // Ưu tiên hộp thoại chi tiết với tiến độ nhúng trong tab Dịch; không dùng hộp thoại workflow cũ.
