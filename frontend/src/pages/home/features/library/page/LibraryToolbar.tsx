...
const SORT_OPTIONS = [
  ...
  { value: "created", label: "Recently uploaded" },
    ...
    <div className="mb-4 border-b border-border/10 pb-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-baseline gap-2">
          <span className="truncate text-[15px] font-semibold tracking-tight text-foreground/90 sm:text-[16px]">All Library</span>
        ...
        <div className="flex flex-wrap items-center gap-2 sm:justify-end">
          ...
          <div className="inline-flex h-8 shrink-0 items-center rounded-[var(--btn-radius)] bg-muted/20 p-0.5" role="group" aria-label="View">
            <button
              type="button" title="Grid" aria-label="GridView" aria-pressed={viewMode === "grid"}
            ...
            ><IconGrid /></button>
            <button
              type="button" title="List" aria-label="ListView" aria-pressed={viewMode === "list"}
