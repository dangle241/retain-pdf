// Thanh công cụ giá sách, dựa trên LibraryCollectionContextBar của PDF_MD_lib: nhãn ngữ cảnh + số lượng bên trái;
// menu sắp xếp + chuyển lưới/danh sách bên phải; nút lọc thêm ở giai đoạn sau.
    ...
    <div className="mb-4 border-b border-border/10 pb-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-baseline gap-2">
          <span className="truncate text-[15px] font-semibold tracking-tight text-foreground/90 sm:text-[16px]">Toàn bộ thư viện</span>
