// library Domain external entry ââ Page/composition Only import from here; do not import from sub-paths (except for tests).
//
// Table of Contents:
//   shell/      Generic shell (BookCard、BookListRow）
//   actions/    Card action factory (read / translate）
//   display/    Display aids (cover, logo)
//   page/       Bookshelf layout (grid, toolbar,viewPort）
