// Entry công khai của miền library; trang/composition chỉ import từ đây, không đi sâu đường con trừ test.
//
// Thư mục:
//   shell/      Vỏ chung (BookCard, BookListRow)
//   actions/    Factory thao tác thẻ (read / translate)
//   display/    Trợ giúp hiển thị (bìa, huy hiệu)
//   page/       Điều phối trang giá sách (lưới, thanh công cụ, viewPort)
//   categories/ Tab bộ sưu tập
//   favorites/  Tab đã lưu (trích đoạn/ghi chú)
//   detail/     Chi tiết sách (vỏ shell + container Dialog)
