// Tab "Dịch" trong chi tiết: biểu mẫu bắt đầu / dịch lại.
// Tách từ TranslateWorkspacePanel gốc; sách đã trong thư viện nên không cần ô tải lên WorkflowPanel.
    ...
    <div className="book-translate-launch-form space-y-2.5">
      ...
      {canTranslate ? (
        ...
        <p className="text-xs text-muted-foreground">
          Đã dịch xong. Phía trên là tiến độ tác vụ của sách; bên trái có thể chọn “Đọc đối chiếu”.
        </p>
      ) : isActive ? (
        <p className="text-xs text-muted-foreground">
          Đang dịch; tiến độ tự động cập nhật trong tab này. Khi hoàn tất, bạn có thể đọc đối chiếu ở bên trái.
        </p>
      ) : null}
    </div>
  );
