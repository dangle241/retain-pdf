// Cột phải: tiêu đề / tác giả / nhãn + biểu mẫu sửa.
 ...
 * @param {string} props.displayTitle Tiêu đề hiển thị.
      ...
      <div className="min-w-0 flex-1">
        {editing ? (
          <div className="space-y-2.5">
            ...
            />
            <div>
              <p className="mb-1 text-xs text-muted-foreground">Nhãn (phân cách bằng dấu phẩy)</p>
              <input
          ...
          <>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              {authors.length ? authors.join("、") : "Tác giả không xác định"}
              {year ? ` · ${year}` : ""}
            </p>
            {tags.length ? (
