// Nút thử lại giai đoạn (thiết kế §2 features/status/); phản chiếu
// renderStageRetryAction/bindStageRetryEvents trong job-status-card-retry.js; click sẽ dispatch
// APP_EVENTS.retryStage để engine job-runtime xử lý; giữ nguyên hợp đồng sự kiện (thiết kế §5).
