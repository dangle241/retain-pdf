// buildProgressRenderModel được sao chép từ components/status/job-status-card-rendering.js
// dòng 45-164 (quyết định components/status/ trong thiết kế §1; toàn bộ file bị loại sau cutover,
// js/components/ là vùng cấm của cổng chống hồi quy, chỉ được sao chép hàm thuần, không được import).
// Giữ nguyên từng chữ, không thay đổi hành vi; ProgressBlock.jsx / useStagedProgressAnimation.js
// dùng chung file này.
