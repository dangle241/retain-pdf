// Thanh luồng giai đoạn con (thiết kế §2 features/status/); nguồn dữ liệu buildSubstageViewModel là
// VM thuần trong job-status/substage-view-model.js nên import nguyên trạng; phản chiếu
// cấu trúc DOM syncStageSubstageStates trong job-status-card-substages.js,
// giữ hợp đồng biến CSS --status-substage-count).
