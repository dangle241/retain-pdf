// pages/detail is the only exit point for src/js/*.
// DetailApp / components are forbidden from directly importing ../../js/**; if a symbol is missing, only change this file.
