// Thẻ danh sách đầu ra + thẻ xem trước Markdown.
//
// #detail-artifacts-summary / #detail-artifacts-list và
// #detail-markdown-image-grid / #detail-markdown-image-empty là "đảo mệnh lệnh":
// nội dung được mô-đun cũ giữ lại src/js/job-detail/artifacts.js (qua overview-renderer.js /
// markdown-flow.js) ghi bằng innerHTML / classList sau khi tải dữ liệu. Phía React chỉ kết xuất
// khung tĩnh ban đầu giống detail.html cũ; DOM ảo không đổi nên kết xuất lại không
// ghi đè dữ liệu mệnh lệnh. Các trường văn bản khác của thẻ Markdown dùng adapter setText (React state).
  ...
  return (
    <article className="detail-card">
      ...
      <div id="detail-artifacts-list" className="detail-artifact-list">
        <div className="detail-empty">Chưa có danh sách đầu ra</div>
      </div>
    </article>
  );
});
  ...
  return (
    <article className="detail-card">
      ...
      <div className="detail-meta-list">
        <MetaRow label="API JSON" id="detail-markdown-json-url" mono value={t("detail-markdown-json-url")} />
        <MetaRow label="API thô" id="detail-markdown-raw-url" mono value={t("detail-markdown-raw-url")} />
