// Biểu tượng nét dụng cụ khoa học (Kimi tạo, viền currentColor).
...
/**
 * Dùng mask nhận currentColor để biểu tượng theo ink/muted khi đổi chủ đề.
 * (<img> thuần không thể kế thừa stroke currentColor).
 */
