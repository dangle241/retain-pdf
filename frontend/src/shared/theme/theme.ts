// API runtime của giao diện chủ đề.
...
/** Ghi storage + <html data-theme> và phát sự kiện. */
export function setTheme(theme: ThemeId) {
  ...
  if (typeof document !== "undefined") {
    ...
    // Giao diện tối có thể thêm một class cho body để component riêng viết trường hợp .theme-dark.
...
/** Gọi ở đầu cao nhất của entry để giảm FOUC khi đổi giao diện. */
